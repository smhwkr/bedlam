...
int main()
{
    ...
    cudaSolve(dev_occupiedfromid, dev_partials, dev_partialpieces, dev_partialoccupied, dev_partialids, host_active, dev_partial, maxsolutions, dev_solutions, dev_solutionids);
