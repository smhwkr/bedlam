# bedlam v2.4 (GPU, CID/UID, L1 & shared)

This version uses the same **two-tier load-balancing architecture** as v2.3, but attempts to **eliminate the L2 cache latency** incurred when looking up bitmasks.
