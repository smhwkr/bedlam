...
extern "C" void cudaSolve(const ulonglong1 * occupiedfromid, const int* partials, const ushort1 * partialpieces, const ulonglong1 * partialoccupied, const ushort4 * partialids, int* active, int* partial, int maxsolutions, int* solutions, ushort4(*solutionids)[4], int multiprocessors);
...
int main()
{
    ...
    cudaSolve(dev_occupiedfromid, dev_partials, dev_partialpieces, dev_partialoccupied, dev_partialids, host_active, dev_partial, maxsolutions, dev_solutions, dev_solutionids, multiprocessors);
