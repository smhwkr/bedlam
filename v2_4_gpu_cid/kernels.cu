...
extern "C" void cudaSolve(const ulonglong1* occupiedfromcid, const int* partials, const ushort2* partialpieces, const ulonglong1* partialoccupied, const ushort4* partialcids, int* active, int* producers, int* partial, int maxsolutions, int* solutions, ushort4(*solutioncids)[4], int multiprocessors)
{
    ...
    *producers = 0;
    ...
    kernelSolve<<<grid_dim, block_dim>>> (occupiedfromcid, partials, partialpieces, partialoccupied, partialcids, active, producers, partial, maxsolutions, solutions, solutioncids);
}
