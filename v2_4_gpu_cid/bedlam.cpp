...
int main()
{
    ...
    cudaSolve(dev_occupiedfromcid, dev_partials, dev_partialpieces, dev_partialoccupied, dev_partialcids, host_active, host_producers, dev_partial, maxsolutions, dev_solutions, dev_solutioncids, multiprocessors);
