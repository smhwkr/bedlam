# bedlam v2.7 (GPU, rotation/RID, shared)
...
The first lookup uses the CID to retrieve the appropriate rotation.
...
![Alt text](../assets/v2_7_architecture.svg)

This is a plot of active, producer, and consumer threads over time:

![Alt text](../assets/v2_7_chart.svg)
